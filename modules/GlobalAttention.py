#!/usr/bin/env python
#-*- coding:utf-8 -*-
# file name: GlobalAttention.py
# file description:
# created at:3/10/2021 3:32 PM
...
from modules.utils.sparse_activations import sparsemax
from modules.utils.misc import aeq, sequence_mask
